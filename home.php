	        	...
	        	<div class="col-sm-10 col-sm-offset-1">
				    ...
				    <?php
				    	...
				    	if($vquery->num_rows > 0){
				    		?>
				    		<div class="text-center" style=" font-size: 35px; font-family:Times" >
					    		<h3  style="margin-top:70px ; margin-bottom:50px ;font-size:40px ; font-family:bold">You have already voted for this election.</h3>
					    		<a href="#view" data-toggle="modal" style="color:white ;background-image: linear-gradient(to right, #3b82f6, #2563eb);  ;font-size:bold; padding:8px ;padding-x:6 ;border-radius:20px " >View Ballot</a>
					    	</div>
				    		<?php
				    	}
				    	else{
